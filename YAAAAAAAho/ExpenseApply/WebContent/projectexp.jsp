			...
			<div class="col s12 m4 l3">
				<div class="collection">
					<s:if test="currentUserType == '财务人员'">
						...
						<a href="load_expense_req" class="collection-item active">项目报销</a>
							...
							<div class="col s12">
								...
								<div class="input-field col s6">
									<input placeholder="请输入单位名称" id="unit_name" name="unit_name"
										type="text" class="validate" required="true"> <label for="unit_name">单位</label>
								</div>
								<div class="input-field col s6">
									<input placeholder="请输入项目经费代码" id="budget_id" name="budget_id"
										type="number" class="validate" required="true"> <label for="budget_id">经费项目代码</label>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col s12">
								<div class="input-field col s4">
									<input placeholder="请输入整数" id="qu_bill" name="qu_bill"
										type="number" class="validate" required="true"><label for="qu_bill">单据数量</label>
								</div>

								<div class="file-field input-field col s8">
									<div class="waves-effect waves-light btn">
										<span>文件</span> <input type="file" name="file" required="true">
									</div>
