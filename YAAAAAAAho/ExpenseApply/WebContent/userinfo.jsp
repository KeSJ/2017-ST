		...
		<div class="row">
			<div class="col s12 m4 l3">
				<div class="collection">
					<s:if test="currentUserType == '财务人员'">
						...
						<a href="userinfo.jsp" class="collection-item active">个人信息修改</a>
					</s:if>
			...
			<div class="col s12 m8 l9">
				<div class="card-panel white">
					<h6>您好，${currentUserName } 老师</h6>

					<div class="row">
						<div class="col s12">
							<div class="input-field col s6">
								<input disabled value="${currentUserId}" id="teacher_id"
									name="teacher_id" type="text" class="validate"> <label
									for="teacher_id">教师账号（工号）</label>
							</div>
						</div>
					</div>
					<hr class="hr0">
					<form action="ModifyPassword" method="post" id="modpassword"
						name="modpassword">
						<div class="row">
							<div class="col s6">
								<h6>修改密码</h6>
								<div class="input-field col s12">
									<input placeholder="请输入原密码" type="password" id="password1"
										name="password1" class="validate" required="true"> <label
										for="password1">原密码</label>
								</div>
								<div class="input-field col s12">
									<input placeholder="请输入新密码" type="password" id="password2"
										name="password2" class="validate" required="true"> <label
										for="password2">新密码</label>
								</div>
								<div class="input-field col s12">
									<input placeholder="请重复输入密码" type="password" id="password3"
										name="password3" class="validate" required="true"> <label
										for="password3">重复密码</label>
								</div>
							</div>
						</div>
						<div class="row">
							<button class="btn waves-effect waves-teal col s2 offset-s9"
