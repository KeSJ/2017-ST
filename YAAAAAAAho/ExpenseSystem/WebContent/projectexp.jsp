				...
				<div class="card-panel white">
					<form action="project_request">
							...
							<div class="col s12">
								...
								<div class="file-field input-field col s8">
									<div class="waves-effect waves-light btn">
										<span>文件</span> <input type="file" name="files" multiple>
									</div>
						...
						<div class="row">
							...
							<div class="col s12">
								<div class="input-field col s6">
									<input type="number" step="0.01" id="total_money"
										name="total_money"><label for="total_money">合计金额</label>
								</div>
							</div>
						</div>
						<div class="row">
									...
									onclick="del(this)"><i class="material-icons">delete</i></a>
											...
											<div class="input-field col s3">
												<input type="text" id="teacher_name" name="teacher_name"
													placeholder=" "><label class="active"
											...
											<div class="input-field col s2">
												<input type="number" step="0.01" id="exp_money"
													...
													class="active" for="exp_money">转账金额</label>
											</div>
										</td>
									</tr>
								</table>
