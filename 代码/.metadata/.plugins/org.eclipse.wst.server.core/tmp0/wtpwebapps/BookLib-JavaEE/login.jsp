		...
		<div class="row">
			...
			<div class="row">
				<div class="well col-md-5 center login-box">
					<div class="alert alert-info">${returnMsg}&nbsp&nbsp&nbsp请输入账号和密码</div>
					<form class="form-horizontal" action="login" method="post">
						<fieldset>
							<div class="input-group input-group-lg">
								<span class="input-group-addon"><i
									class="glyphicon glyphicon-user red"></i></span> <input type="text"
									class="form-control" placeholder="账号" name="userId">
							</div>
							...
							<div class="input-group input-group-lg">
								<span class="input-group-addon"><i
									...
									type="password" class="form-control" placeholder="密码" name="pwd">
							</div>
							<div class="clearfix"></div>
