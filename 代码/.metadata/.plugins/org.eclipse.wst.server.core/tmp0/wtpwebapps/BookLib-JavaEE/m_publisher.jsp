					...
					<div class="box col-md-12">
						<div class="box-inner">
							...
							<div class="box-content">
								<a class="btn btn-primary btn-sm" href="load_add_publisher">添加出版社</a>
								<br>
								<table
									...
									<tbody>
										<s:iterator value="publishers" id="list">
											<tr>
												<td class="center"><s:property
														value="#list.pubid" /></td>
												<td class="center"><s:property
														value="#list.publisherName" /></td>
												<td class="center"><s:property
														value="#list.address" /></td>

												<td class="center"><a class="btn btn-info"
													href="load_modify_publisher?pubid=<s:property value='#list.pubid' />">
														<i class="glyphicon glyphicon-edit icon-white"></i> 修改
												</a> <a id="delete" class="btn btn-danger"
													onclick="return confirm('确定删除此出版社?')"
													href="delete_publisher?pubid=<s:property value='#list.pubid' />" >
