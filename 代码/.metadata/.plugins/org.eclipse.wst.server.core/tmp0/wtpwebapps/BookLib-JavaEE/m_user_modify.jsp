		...
		<div id="content" class="col-lg-10 col-sm-10">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li><a href="manage_user">系统用户管理</a></li>
					<li>修改用户信息</li>
				</ul>
			</div>
						...
						<div class="box-content">
							...
							<div class="row">
								<div class="well col-md-5 center login-box">
									<div class="alert alert-info">${returnMsg}&nbsp&nbsp&nbsp请输入需要修改的用户信息</div>
									<form class="form-horizontal" action="modify_user"
										method="post">
										<fieldset>
											<div class="input-group input-group-lg">
												<span class="input-group-addon">账&nbsp&nbsp&nbsp号</span> <input
											...
											<s:set name="currentusertype" value="currentUserType"></s:set>
											<s:if test="#currentusertype == 'admin'">
												<div class="input-group input-group-lg">
													<span class="input-group-addon">用户类型</span>
													<table class="form-control">
														<tr>
															<s:set name="usertype" value="type"></s:set>
															<s:if test="#usertype == 'normal'">
																<td><input id="
															admin" type="radio"
																	name="userType" value="admin">admin&nbsp&nbsp&nbsp&nbsp</td>

																<td><input id="normal" type="radio" name="userType"
																	value="normal" checked="checked">normal</td>
															</s:if>
															<s:else>
																<td><input id="admin" type="radio" name="userType"
																	value="admin" checked="checked">admin&nbsp&nbsp&nbsp&nbsp</td>
																<td><input id="normal" type="radio" name="userType"
																	value="normal">normal</td>
															</s:else>
														</tr>
													</table>
												</div>
