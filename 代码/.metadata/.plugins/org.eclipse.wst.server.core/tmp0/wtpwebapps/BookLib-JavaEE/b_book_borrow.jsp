							...
							<div class="box-content">
								...
								<div class="row">
									<div class="well col-md-5 center login-box">
										<div class="alert alert-info">${returnMsg}&nbsp&nbsp&nbsp请输入借书信息</div>
										<form class="form-horizontal" action="borrow" method="post">
											<fieldset>

												<div class="input-group input-group-lg">
													<span class="input-group-addon">读者ID</span> <input
												...
												<div class="input-group input-group-lg">
													<span class="input-group-addon">图书条码</span> <input
														type="text" class="form-control" name="bookBarcode">
												</div>
