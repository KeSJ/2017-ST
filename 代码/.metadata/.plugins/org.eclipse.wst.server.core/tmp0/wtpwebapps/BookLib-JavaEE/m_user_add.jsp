							...
							<div class="box-content">
								...
								<div class="row">
									<div class="well col-md-5 center login-box">
										<div class="alert alert-info">${returnMsg}&nbsp&nbsp&nbsp请输入新用户信息</div>
										<form class="form-horizontal" action="add_user" method="post">
											<fieldset>
												...
												<div class="input-group input-group-lg">
													<span class="input-group-addon">选择用户类型</span>
													<table class="form-control">
														<tr>
															<td><input id="admin" type="radio" name="type"
																value="admin">admin&nbsp&nbsp&nbsp&nbsp</td>
															<td><input id="normal" type="radio" name="type"
