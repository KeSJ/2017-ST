							...
							<div class="box-content">
								...
								<div class="row">
									<div class="well col-md-5 center login-box">
										<div class="alert alert-info">${returnMsg}&nbsp&nbsp&nbsp请输入新读者类别信息</div>
										<form class="form-horizontal" action="add_reader_type"
											method="post">
											<fieldset>

												<div class="input-group input-group-lg">
													<span class="input-group-addon">读者类别名称</span> <input
														type="text" class="form-control" name="readerTypeName">
												</div>
