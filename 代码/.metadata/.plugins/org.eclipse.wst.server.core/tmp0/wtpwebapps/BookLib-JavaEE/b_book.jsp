					...
					<div class="box col-md-12">
						<div class="box-inner">
							...
							<div class="box-content">
								<ul class="collapse navbar-collapse nav navbar-nav top-menu">
									<li><a class="btn btn-primary btn-sm" href="load_add_book">添加图书</a></li>
									<li>
										<form class="navbar-search pull-left" action="" name="search">
											<ul class="collapse navbar-collapse nav navbar-nav top-menu">
												<li><input placeholder="搜索图书信息"
													class="search-query form-control col-md-10" name="massage"
													type="text" /></li>
												<li><input class="btn btn-primary btn-sm" value="按条码查询"
													type="submit" onclick="search_barcode()"></li>
												<li><input class="btn btn-primary btn-sm" value="按书名查询"
													type="submit" onclick="search_bookname()"></li>
											</ul>
										</form>
								...
								<table
									...
									<tbody>
										<s:iterator value="books" id="list">
											<tr>
												<td class="center"><s:property value="#list.barcode" /></td>
												<td class="center"><s:property value="#list.bookname" /></td>
												<td class="center"><s:property value="#list.pubName" /></td>
												<td class="center"><s:property value="#list.price" /></td>
												<s:if test="#list.state == '在库'">
													<td class="center"><span
														class="label-success label label-default">在库</span></td>
													<td class="center"><a class="btn btn-info"
														href="load_modify_book?barcode=<s:property value="#list.barcode"/>">
															<i class="glyphicon glyphicon-edit icon-white"></i> 修改
													</a> <a id="delete" class="btn btn-danger"
														onclick="return confirm('确定下架此书籍?')"
														href="stop_book?barcode=<s:property value='#list.barcode' />">
															<i class="glyphicon glyphicon-trash icon-white"></i> 下架
													</a></td>
												</s:if>
												<s:elseif test="#list.state == '借出'">
													<td class="center"><span class="label label-warning">借出</span></td>
													<td class="center"><a class="btn btn-info"
														href="load_modify_book?barcode=<s:property value="#list.barcode"/>">
															<i class="glyphicon glyphicon-edit icon-white"></i> 修改
													</a>
												...
												<s:else>
													<td class="center"><span class="label-default label">下架</span></td>
													<td class="center"></td>
												</s:else>
											</tr>
										</s:iterator>
