			...
			<div id="content" class="col-lg-10 col-sm-10">
				...
				<div>
					<ul class="breadcrumb">
						...
						<li><a href="manage_reader">读者信息管理</a></li>
						<li>添加读者</li>
					</ul>
				</div>
							...
							<div class="box-content">
								...
								<div class="row">
									<div class="well col-md-5 center login-box">
										<div class="alert alert-info">${returnMsg}&nbsp&nbsp&nbsp请输入新读者信息</div>
										<form class="form-horizontal" action="add_reader"
											method="post">
											<fieldset>
												<div class="input-group input-group-lg">
													<span class="input-group-addon">读者证号</span> <input
														type="text" class="form-control" name="readerId">
												</div>
												<div class="clearfix"></div>
												<br>

												<div class="input-group input-group-lg">
													<span class="input-group-addon">读者姓名</span> <input
												...
												<div class="input-group input-group-lg">
													...
													<table class="form-control">
														<tr>
															<td><s:select list="readerTypes" name="readerType" id="readerTypeId"
																	listKey="readerTypeId" listValue="readerTypeName" ></s:select>
															</td>
														</tr>
													</table>
												</div>
