					...
					<div class="box col-md-12">
						<div class="box-inner">
							...
							<div class="box-content">
								<a class="btn btn-primary btn-sm" href="load_add_reader">添加读者</a>
								<br>
								<table
									...
									<tbody>
										<s:iterator value="readers" id="list">
											<tr>
												<td class="center"><s:property value="#list.readerId" /></td>
												<td class="center"><s:property value="#list.readerName" /></td>
												<td class="center"><s:property
														value="#list.readerTypeName" /></td>
												<td class="center"><s:property
														value="#list.lendBookLimitted" /></td>

												<s:if test="#list.readerState == '正常'">
													<td class="center"><span
														class="label-success label label-default">正常</span></td>
													<td class="center">
														<a class="btn btn-info"
														href="load_modify_reader?readerId=<s:property value="#list.readerId"/>">
															<i class="glyphicon glyphicon-edit icon-white"></i> 修改</a>
														<a class="btn btn-warning" onclick="return confirm('确定挂失此读者？')"
														href="stop_reader?readerId=<s:property value="#list.readerId"/>"><i
															class="glyphicon glyphicon-ban-circle"></i> 挂失</a>
														<a id="delete" class="btn btn-danger"
														onclick="return confirm('确定删除此读者?')"
														href="delete_reader?readerId=<s:property value='#list.readerId' />">
															<i class="glyphicon glyphicon-trash icon-white"></i> 删除
													</a></td>
												</s:if>
												<s:elseif test="#list.readerState == '挂失'">
													<td class="center"><span class="label label-warning">挂失</span></td>
													<td class="center">
														<a class="btn btn-info"
														href="load_modify_reader?readerId=<s:property value="#list.readerId"/>">
															<i class="glyphicon glyphicon-edit icon-white"></i> 修改</a>
														<a class="btn btn-success" onclick="return confirm('确定解挂此读者？')"
														href="start_reader?readerId=<s:property value="#list.readerId"/>"><i
															class="glyphicon glyphicon-ban-circle"></i> 解挂</a>
														<a id="delete" class="btn btn-danger"
														onclick="return confirm('确定删除此读者?')"
														href="delete_reader?readerId=<s:property value='#list.readerId' />">
															<i class="glyphicon glyphicon-trash icon-white"></i> 删除
												...
												<s:else>
													<td class="center"><span class="label-default label">删除</span></td>
													<td class="center"></td>
												</s:else>
											</tr>
										</s:iterator>
