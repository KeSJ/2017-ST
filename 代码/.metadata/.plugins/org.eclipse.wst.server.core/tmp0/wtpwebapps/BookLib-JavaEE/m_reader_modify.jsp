							...
							<div class="box-content">
								...
								<div class="row">
									<div class="well col-md-5 center login-box">
										<div class="alert alert-info">${returnMsg}&nbsp&nbsp&nbsp请输入要修改的读者信息</div>
										<form class="form-horizontal" action="modify_reader"
											method="post">
											<fieldset>
												<div class="input-group input-group-lg">
													<span class="input-group-addon">读者证号</span> <input
														type="text" class="form-control" name="readerId" value="${readerId }" readonly>
												</div>
												...
												<div class="input-group input-group-lg">
													<span class="input-group-addon">读者姓名</span> <input
														type="text" class="form-control" name="readerName" value="${readerName }">
												</div>
												<div class="clearfix"></div>
												<br>
