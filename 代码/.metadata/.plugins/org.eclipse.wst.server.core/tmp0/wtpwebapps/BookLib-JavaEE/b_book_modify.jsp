			...
			<div id="content" class="col-lg-10 col-sm-10">
				...
				<div>
					<ul class="breadcrumb">
						...
						<li><a href="manage_book">图书信息管理</a></li>
						<li>修改图书信息</li>
					</ul>
				</div>
							...
							<div class="box-content">
								...
								<div class="row">
									<div class="well col-md-5 center login-box">
										<div class="alert alert-info">${returnMsg}&nbsp&nbsp&nbsp请输入要修改的图书信息</div>
										<form class="form-horizontal" action="modify_book"
											method="post">
											<fieldset>
												<div class="input-group input-group-lg">
													<span class="input-group-addon">条码</span> <input
														type="text" class="form-control" name="barcode" value="${barcode }" readonly>
												</div>
												<div class="clearfix"></div>
												<br>

												<div class="input-group input-group-lg">
													<span class="input-group-addon">书名</span> <input
														type="text" class="form-control" name="bookname" value="${bookname }">
												</div>
												<div class="clearfix"></div>
												<br>

												<div class="input-group input-group-lg">
													<span class="input-group-addon">价格</span> <input
