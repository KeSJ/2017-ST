							...
							<div class="box-content">
								...
								<div class="row">
									<div class="well col-md-5 center login-box">
										<div class="alert alert-info">${returnMsg}&nbsp&nbsp&nbsp请输入要修改的出版社信息</div>
										<form class="form-horizontal" action="modify_publisher"
											method="post">
											<fieldset>

												<div class="input-group input-group-lg">
													<span class="input-group-addon">出版社ID</span> <input
														type="text" class="form-control" name="pubid" value="${pubid }" readonly>
												</div>
												...
												<div class="input-group input-group-lg">
													<span class="input-group-addon">出版社名称</span> <input
														type="text" class="form-control" name="publisherName" value="${publisherName }">
												</div>
												<div class="clearfix"></div>
												<br>
