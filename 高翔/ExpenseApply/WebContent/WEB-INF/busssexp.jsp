    ...
    <div class="row">
        <div class="col s12 m4 l3">
            <div class="collection">
                ...
                <a href="statistics.html" class="collection-item">统计分析</a>//左边菜单
            </div>
        </div>
        ...
        <div class="col s12 m8 l9">
            <div class="card-panel white">
                <div class="row">
                    <div class="col s12">
                        <h6>
                            <strong>报销单位及人员信息</strong>//表单开始  看看一共涉及到几个表
                        </h6>
                        <div class="input-field col s6">
                            <input placeholder="请输入单位名称" id="companyName" type="text"
                                   class="validate"> <label for="companyName">单位</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col s12">
                        <div class="input-field col s3">
                            <input placeholder="姓名" id="teacher_name1" type="text"
                                   class="validate"><label for="teacher_name1">报销人</label>
                        </div>
                        <div class="input-field col s3">
                            <input id="teacher_position1" type="text" class="validate"><label
                                for="teacher_position1">职称（务）</label>
                        </div>
                        <div class="input-field col s3">
                            <input placeholder="姓名" id="teacher_name2" type="text"
                                   class="validate"><label for="teacher_name2">报销人</label>
                        </div>
                        <div class="input-field col s3">
                            <input id="teacher_position2" type="text" class="validate"><label
                                for="teacher_position2">职称（务）</label>
                        </div>
                        <div class="input-field col s3">
                            <input placeholder="姓名" id="teacher_name3" type="text"
                                   class="validate"><label for="teacher_name3">报销人</label>
                        </div>
                        <div class="input-field col s3">
                            <input id="teacher_position3" type="text" class="validate"><label
                                for="teacher_position3">职称（务）</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col s12">
                        <div class="input-field col s4">
                            <select><option value="" disable selected></option>
                                <option value="1">option test</option>
                            </select> <label>项目经费代码</label>
                        </div>
                        <div class="input-field col s8">
                            <input id="buss_reason" type="text" class="validate"><label
                ...
                <div class="row">
                    <div class="col s12">
                        <div class="input-field col s4">
                            <input placeholder="请输入整数" id="qu_bill" type="number"
                                   class="validate"><label for="qu_bill">单据数量</label>
                        </div>
                        <form action="#">
                            <div class="file-field input-field col s8">
                                <div class="waves-effect waves-light btn">
                                    <span>文件</span> <input type="file" multiple>
                                </div>
                ...
                <div class="row">
                    <div class="col s12">
                        ...
                        <div class="input-field col s2">
                            <input type="text" id="teacher_id" placeholder="请输入登录账号"><label
                                for="teacher_id">工号</label>
                        </div>
                        <div class="input-field col s3">
                            <input type="text" id="teacher_name" placeholder=" "><label
                                for="teacher_name">姓名</label>
                        </div>
                        <div class="input-field col s5">
                            <input type="text" id="bank_id" placeholder=" "><label
                                for="bank_id">银行卡号</label>
                        </div>
                        <div class="input-field col s2">
                            <input type="text" id="exp_money" placeholder="RMB"><label
