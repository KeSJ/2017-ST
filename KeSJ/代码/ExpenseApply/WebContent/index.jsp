	...
	<div id="index-banner" class="parallax-container">
		<div class="section no-pad-bot">
			...
			<div class="container">
				...
				<h1 class="header center teal-text text-lighten-2"><br> 浙江大学城市学院</h1>
								...
								<div class="col m8 offset-m2 s12">
									<div class="row email required user_email">
										<div class="input-field col s12">
											<label class="email required control-label" for="user_email">用户名</label><input
												class="string email required" placeholder="教职工编号"
												type="email" value="" name="user[email]" id="user_email" /><span
									...
									<div class="row password optional user_password">
										<div class="input-field col s12">
											<label class="password optional control-label"
												...
												type="password" name="user[password]" id="user_password" /><span
												class="help-block">请输入密码</span>
										</div>
									</div>
									<div class="center input-field row">
										<a class="btn btn-large green waves-effect waves-light s12 col" href="main.html">
											登入</a>
									</div>
