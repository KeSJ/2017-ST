				...
				<div class="card-panel white">
					<div class="row">
						<div class="col s12">
							...
							<div class="input-field col s6">
								<input placeholder="请输入单位名称" id="project_name" type="text"
					...
					<div class="row">
						<div class="col s12">
							...
							<div class="input-field col s3">
								<input id="teacher_type1" type="text" class="validate"><label
							...
							<div class="input-field col s3">
								<input id="teacher_type2" type="text" class="validate"><label
							...
							<div class="input-field col s3">
								<input id="teacher_type3" type="text" class="validate"><label
