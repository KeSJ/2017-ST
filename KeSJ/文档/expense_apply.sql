...
CREATE TABLE `expense` (
  ...
  `EAppDate` datetime NOT NULL,
  `EAgent` varchar(20) DEFAULT NULL,
  `ECheckStaff` varchar(10) DEFAULT NULL,
  `ECheckDate` datetime DEFAULT NULL,
...
CREATE TABLE `proplancategory` (
  ...
  `PPCInUse` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`PPCCode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `proplancategory` VALUES ('A11', '自然科学基金重大项目', '1');
INSERT INTO `proplancategory` VALUES ('A12', '自然科学基金一般项目', '1');
INSERT INTO `proplancategory` VALUES ('A13', '自然科学基金青年人才培养专项资金项目', '1');
INSERT INTO `proplancategory` VALUES ('C01', '重大科技专项（优先主题）重大工业项目', '1');
INSERT INTO `proplancategory` VALUES ('C02', '重大科技专项（优先主题）重大农业项目', '1');
INSERT INTO `proplancategory` VALUES ('C03', '重大科技专项（优先主题）重大社会发展项目', '1');
INSERT INTO `proplancategory` VALUES ('C04', '重大科技专项（优先主题）重大国际科技合作合作研究项目', '1');
INSERT INTO `proplancategory` VALUES ('C06', '重大科技专项（优先主题）重大国内合作成果转化项目', '1');
INSERT INTO `proplancategory` VALUES ('C07', '重大科技专项（优先主题）重大”863”科技成果对接项目', '1');
INSERT INTO `proplancategory` VALUES ('C11', '重大科技专项（优先主题）重点工业项目', '1');
INSERT INTO `proplancategory` VALUES ('C12', '重大科技专项（优先主题）重点农业项目', '1');
INSERT INTO `proplancategory` VALUES ('C13', '重大科技专项（优先主题）重点社会发展项目', '1');
INSERT INTO `proplancategory` VALUES ('C14', '重大科技专项（优先主题）重点国际科技合作合作研究项目', '1');
INSERT INTO `proplancategory` VALUES ('C15', '重大软科学项目', '1');
INSERT INTO `proplancategory` VALUES ('C16', '重大科技专项（优先主题）重点国内合作成果转化项目', '1');
INSERT INTO `proplancategory` VALUES ('C17', '重大科技专项（优先主题）重点”863”科技成果对接项目', '1');
INSERT INTO `proplancategory` VALUES ('C21', '公益技术应用研究工业项目', '1');
INSERT INTO `proplancategory` VALUES ('C22', '公益技术应用研究农业项目', '1');
INSERT INTO `proplancategory` VALUES ('C23', '公益技术应用研究社会发展项目', '1');
INSERT INTO `proplancategory` VALUES ('C24', '公益技术应用研究科技合作项目', '1');
INSERT INTO `proplancategory` VALUES ('C25', '重点软科学项目', '1');
INSERT INTO `proplancategory` VALUES ('C35', '一般软科学项目', '1');
INSERT INTO `proplancategory` VALUES ('C80', '自主知识产权成果转化项目', '1');
INSERT INTO `proplancategory` VALUES ('D20', '火炬计划', '1');
INSERT INTO `proplancategory` VALUES ('D30', '星火计划', '1');
INSERT INTO `proplancategory` VALUES ('D40', '科技型中小企业技术创新项目', '1');
INSERT INTO `proplancategory` VALUES ('D60', '新产品计划', '1');
INSERT INTO `proplancategory` VALUES ('D70', '农业科技成果转化项目', '1');
INSERT INTO `proplancategory` VALUES ('D80', '国际科技合作与引进消化吸收再创新重点项目', '1');
INSERT INTO `proplancategory` VALUES ('E10', '重点实验室和中试基地', '1');
INSERT INTO `proplancategory` VALUES ('E20', '区域科技创新服务中心', '1');
INSERT INTO `proplancategory` VALUES ('E40', '高新技术企业研究开发中心', '1');
INSERT INTO `proplancategory` VALUES ('E60', '科技创新平台', '1');
INSERT INTO `proplancategory` VALUES ('E70', '重点科技企业孵化器', '1');
INSERT INTO `proplancategory` VALUES ('E80', '引进大院名校共建创新载体', '1');
INSERT INTO `proplancategory` VALUES ('F10', '省属科研院所专项科技条件建设项目', '1');
INSERT INTO `proplancategory` VALUES ('F20', '省属科研院所专项创新团队建设与人才培项目', '1');
INSERT INTO `proplancategory` VALUES ('F30', '省属科研院所专项公共科技服务项目', '1');
INSERT INTO `proplancategory` VALUES ('G10', '科技特派员和科技扶贫', '1');
INSERT INTO `proplancategory` VALUES ('G20', '网上技术市场重点签约项目', '1');
INSERT INTO `proplancategory` VALUES ('G30', '长三角科技合作项目', '1');
INSERT INTO `proplancategory` VALUES ('G40', '院士基金', '1');
INSERT INTO `proplancategory` VALUES ('G90', '其他', '1');
INSERT INTO `proplancategory` VALUES ('R10', '钱江人才', '1');
INSERT INTO `proplancategory` VALUES ('R20', '科研院所优秀青年科技人才资助计划', '1');
INSERT INTO `proplancategory` VALUES ('R40', '新苗人才', '1');
...
CREATE TABLE `protecres` (
  ...
  `PTRInUse` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`PTRCode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `protecres` VALUES ('1', '自主开发', '1');
INSERT INTO `protecres` VALUES ('2', '产学研合作开发', '1');
...
CREATE TABLE `tecmngarea` (
  ...
  `TMAInUse` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`TMACode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `tecmngarea` VALUES ('A1', '电子信息', '1');
INSERT INTO `tecmngarea` VALUES ('A11', '网络', '1');
INSERT INTO `tecmngarea` VALUES ('A12', '通信', '1');
INSERT INTO `tecmngarea` VALUES ('A13', '计算机硬件', '1');
INSERT INTO `tecmngarea` VALUES ('A14', '计算机软件', '1');
INSERT INTO `tecmngarea` VALUES ('A15', '自动化控制', '1');
INSERT INTO `tecmngarea` VALUES ('A16', '电子及其他', '1');
INSERT INTO `tecmngarea` VALUES ('A2', '能源', '1');
INSERT INTO `tecmngarea` VALUES ('A21', '新能源', '1');
INSERT INTO `tecmngarea` VALUES ('A22', '节能技术及其他', '1');
INSERT INTO `tecmngarea` VALUES ('A30', '交通', '1');
INSERT INTO `tecmngarea` VALUES ('A4', '材料', '1');
INSERT INTO `tecmngarea` VALUES ('A41', '无机材料', '1');
INSERT INTO `tecmngarea` VALUES ('A42', '有机材料', '1');
INSERT INTO `tecmngarea` VALUES ('A43', '金属材料', '1');
INSERT INTO `tecmngarea` VALUES ('A5', '化工', '1');
INSERT INTO `tecmngarea` VALUES ('A51', '无机化工', '1');
INSERT INTO `tecmngarea` VALUES ('A52', '有机化工', '1');
INSERT INTO `tecmngarea` VALUES ('A53', '精细化工', '1');
INSERT INTO `tecmngarea` VALUES ('A54', '催化', '1');
INSERT INTO `tecmngarea` VALUES ('A55', '化学工程与工艺', '1');
INSERT INTO `tecmngarea` VALUES ('A60', '纺织', '1');
INSERT INTO `tecmngarea` VALUES ('A70', '轻工', '1');
INSERT INTO `tecmngarea` VALUES ('A8', '建材与城建', '1');
INSERT INTO `tecmngarea` VALUES ('A80', '建材', '1');
INSERT INTO `tecmngarea` VALUES ('A85', '城建', '1');
INSERT INTO `tecmngarea` VALUES ('A9', '机电', '1');
INSERT INTO `tecmngarea` VALUES ('A91', '机电一体化', '1');
INSERT INTO `tecmngarea` VALUES ('A92', '通用机械与设备', '1');
INSERT INTO `tecmngarea` VALUES ('A93', '化工机械', '1');
INSERT INTO `tecmngarea` VALUES ('A94', '仪器仪表', '1');
INSERT INTO `tecmngarea` VALUES ('B1', '种植业', '1');
INSERT INTO `tecmngarea` VALUES ('B11', '粮油作物', '1');
INSERT INTO `tecmngarea` VALUES ('B12', '经济作物', '1');
INSERT INTO `tecmngarea` VALUES ('B2', '渔业', '1');
INSERT INTO `tecmngarea` VALUES ('B21', '海洋渔业', '1');
INSERT INTO `tecmngarea` VALUES ('B22', '淡水渔业', '1');
INSERT INTO `tecmngarea` VALUES ('B3', '林特业', '1');
INSERT INTO `tecmngarea` VALUES ('B31', '林业', '1');
INSERT INTO `tecmngarea` VALUES ('B32', '林特产', '1');
INSERT INTO `tecmngarea` VALUES ('B4', '畜牧业', '1');
INSERT INTO `tecmngarea` VALUES ('B41', '畜禽养殖', '1');
INSERT INTO `tecmngarea` VALUES ('B49', '其他畜牧业', '1');
INSERT INTO `tecmngarea` VALUES ('B5', '农产品加工', '1');
INSERT INTO `tecmngarea` VALUES ('B51', '动植物加工', '1');
INSERT INTO `tecmngarea` VALUES ('B52', '林特产加工及其他', '1');
INSERT INTO `tecmngarea` VALUES ('C1', '医药卫生', '1');
INSERT INTO `tecmngarea` VALUES ('C11', '外科', '1');
INSERT INTO `tecmngarea` VALUES ('C12', '内科', '1');
INSERT INTO `tecmngarea` VALUES ('C13', '综合医学', '1');
INSERT INTO `tecmngarea` VALUES ('C14', '生物制药', '1');
INSERT INTO `tecmngarea` VALUES ('C15', '化学制药', '1');
INSERT INTO `tecmngarea` VALUES ('C16', '中医药', '1');
INSERT INTO `tecmngarea` VALUES ('C2', '资源与环境', '1');
INSERT INTO `tecmngarea` VALUES ('C21', '资源开发利用', '1');
INSERT INTO `tecmngarea` VALUES ('C22', '环保技术', '1');
INSERT INTO `tecmngarea` VALUES ('C23', '环保装备', '1');
INSERT INTO `tecmngarea` VALUES ('C30', '社会事业', '1');
INSERT INTO `tecmngarea` VALUES ('C40', '服务业', '1');
INSERT INTO `tecmngarea` VALUES ('C5', '海洋', '1');
INSERT INTO `tecmngarea` VALUES ('C51', '养殖与捕捞', '1');
